...
<span class="example" id="exm:causal-exaxylag1"><strong>(\#exm:causal-exaxylag1) </strong></span>设$\{ \varepsilon_t, \eta_t \}$是相互独立的零均值白噪声列，
...
\BeginKnitrBlock{example}
<span class="example" id="exm:causal-exaxylag2"><strong>(\#exm:causal-exaxylag2) </strong></span>在例\@ref(exm:causal-exaxylag1)中，如果模型改成
$$\begin{aligned}
